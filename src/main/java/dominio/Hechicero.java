...
public class Hechicero extends Casta {
	 ...
	 * @param da�o_crit da�o crítico
	 */

	public Hechicero(final double prob_crit, final double evasion, final double da�o_crit) {
		super("Hechicero", prob_crit, evasion, da�o_crit);
	}
