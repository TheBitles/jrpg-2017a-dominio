 ...
 * AdemÃ¡s implementa la interfaz Peleable por lo que debe implementar sus mÃ©todos.
 */
...
public abstract class Personaje extends Character implements Peleable, Serializable {
	...
	/**
	 * InicializaciÃ³n de la tabla de nieveles del juego.
	 */
	...
	/**
	 * Constructor de la clase con valores pasados por parÃ¡metro.
	...
	/**
	 * "atacar" obtiene el ataque de este objeto e invoca al mÃ©todo serAtacado
	 ...
	 * FunciÃ³n lineal de la inteligencia.
	...
	/**
	 * Convierte a un personaje recibido por parÃ¡metro en el aliado de
	...
	/**
	 * habilidadRaza1 serÃ¡ implementado en las clases que hereden de esta.
	 * @param atacado atacado
	...
	/**
	 * habilidadRaza2 serÃ¡ implementado en las clases que hereden de esta.
	 * @param atacado atacado
	 * @return verdadero o falso
	 */
